...
export function generatePDF(itinerary: any) {
  ...
  y = addField("Travel Dates", formatDateRange(itinerary.travelDetails.arrival.date, itinerary.travelDetails.departure.date), 20, y)
  ...
  y = addField("Airport", `${itinerary.travelDetails.arrival.airport} [Google Maps Link]`, 25, y, {
    url: itinerary.travelDetails.arrival.mapLink,
  ...
  // Add Google Maps link for airport
    y = addField("Airport", `${itinerary.travelDetails.departure.airport} [Google Maps Link]`, 25, y, {
      url: itinerary.travelDetails.departure.mapLink,
      text: "[Google Maps Link]",
    })
